...
export const StackProfile = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="LocalNotebook" options={{title: 'Libretas'}} component={LocalNotebookScreen} />
      <Stack.Screen name="LocalSheet" options={{title: 'Hojas'}} component={LocalSheetScreen} />
