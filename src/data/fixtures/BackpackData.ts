...
export const backpackListContentExample: BackpackContents[] =  [
    {
        ...
        currentBackpackBookList: [
            ...
            { id: "2", title: "Libro de Geometria Analitica", uriDocument:'https://bdigital.uncu.edu.ar/objetos_digitales/11619/raichman-geometriaanalitica-actividadesaprendizaje.pdf' }
        ],
        currentBackpackPublicationList: [
            { id: "1", title: "Reunion Con Profesores De INSA-Lyon", link: "https://www.fime.uanl.mx/noticias/aumentan-acuerdos-de-colaboracion-entre-fime-y-insa-lyon/", image: 'https://www.fime.uanl.mx/wp-content/uploads/2022/04/francia2-768x512.jpeg' },
    ...
    },
    {
        ...
        currentBackpackPublicationList: [
            { id: "3", title: "Estreno De La Aplicacion E-UANL", link: "https://campusdigital.uanl.mx/", image: "https://campusdigital.uanl.mx/assets/uanl_app_icon.3abee41f.png" },
